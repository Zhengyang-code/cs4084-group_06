...
class WeatherActivity : AppCompatActivity() {
    ...
    private lateinit var navBtn: View
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        nowLayout = findViewById<View>(R.id.includeNow)
        ...
        val forecastLayoutContainer = findViewById<View>(R.id.includeForecast)
        forecastLayout = forecastLayoutContainer.findViewById(R.id.forecastLayout)

        val lifeIndexLayout = findViewById<View>(R.id.includeLifeIndex)
        ...
        viewModel.weatherLiveData.observe(this, Observer { result ->
            ...
            if (weather != null) {
                ...
                Toast.makeText(this, "Unable to get the weather", Toast.LENGTH_SHORT).show()
